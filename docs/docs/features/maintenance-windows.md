...
- **Uptime checks are paused.** HTTP, ICMP, and TCP checks are skipped entirely, SSL checks are postponed, and the scheduled heartbeat expiry check for push monitors is skipped. This means **no false incidents and no false alerts** are generated by the planned downtime.
