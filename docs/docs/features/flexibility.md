_Kuvasz_ is flexible to [configure](../setup/configuration.md) and also to extend. You can configure your monitors with various options, for example the **HTTP method, interval, headers, body**, etc. 
...
!!! tip 
    ...
    You can find the monitoring configuration options in the [**Managing monitors**](../management/managing-monitors/index.md) section of the documentation.
...
!!! tip
    ...
    Do you miss a specific exporter? Please [open an issue](https://github.com/kuvasz-uptime/kuvasz/issues/new?template=feature_request.md), or consider contributing it yourself! We are always open to new integrations and **would love to see your contribution**.
