...
| Tool                | Description                                                                                                                                             |
|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| `list-integrations` | List all configured integrations (Slack, Discord, Microsoft Teams, Apprise, Pushover, Email, PagerDuty, Telegram, Webhook) with their type and settings |
