...
There is an OpenAPI-compliant [**API documentation**](https://api-docs.kuvasz-uptime.dev) which you can use to explore the available endpoints, their parameters, and responses.
