!!! tip "TL;DR"
    ...
    You can find the installation instructions for the Home Assistant integration here: [**kuvasz-uptime/ku-hass**](https://github.com/kuvasz-uptime/ku-hass#installation)
