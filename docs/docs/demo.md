...
!!!note
    ...
    The demo instance is **configured to be read-only**, so you can explore the features of _Kuvasz_, but you cannot modify the existing monitors/status pages or create new ones. If you want to try out the full functionality, you can [**easily set up your own instance**](setup/installation.md).
