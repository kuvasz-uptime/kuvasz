...
class AppriseMessageFactoryTest(
    ...
    context("the details of the monitor events") {
        ...
        should("omit the API latency of a Docker event") {
            factory.fromUptimeEvent(DockerMonitorUpEvent(dockerMonitor, null, 300)).detailLines() shouldBe emptyList()
        }
        ...
        should("not surface the error of a Docker down event either") {
            factory
                ...
                .detailLines() shouldBe emptyList()
        }
        ...
        should("carry the duration of the previous, ended event of a Docker monitor") {
            ...
            factory.fromUptimeEvent(event).detailLines() shouldBe listOf("Was down for $duration")
        }
