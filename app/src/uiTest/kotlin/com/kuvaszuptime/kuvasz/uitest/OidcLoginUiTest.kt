 ...
 *
 * Keycloak is started in [getProperties], whose return value configures the app's OIDC client with the container's
 * (dynamic) issuer URL before the Micronaut context boots.
 */
