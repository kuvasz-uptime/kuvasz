 ...
 * rows without action buttons), so a single object parameterised by the list path and add-button label covers all.
 */
class ListReadOnlyView(
    private val page: Page,
    private val listPath: String,
    private val addButtonName: String,
) {
    ...
    val addButton: Locator get() = page.byRole(AriaRole.BUTTON, addButtonName)
