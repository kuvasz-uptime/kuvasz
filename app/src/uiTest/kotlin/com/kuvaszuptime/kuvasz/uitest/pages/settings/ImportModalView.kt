...
open class ImportModalView(
    ...
    val importedBadges: Locator get() = modal.getByTestId("$testIdPrefix-result-imported")
    val deletedBadges: Locator get() = modal.getByTestId("$testIdPrefix-result-deleted")
    val ignoredMonitorBadges: Locator get() = modal.getByTestId("$testIdPrefix-result-ignored-monitors")
    val ignoredIntegrationBadges: Locator get() = modal.getByTestId("$testIdPrefix-result-ignored-integrations")
