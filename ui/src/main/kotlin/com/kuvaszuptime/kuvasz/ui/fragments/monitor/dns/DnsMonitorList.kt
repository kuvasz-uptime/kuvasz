...
fun renderDnsMonitorList(
    ...
    createHTML(prettyPrint = false, xhtmlCompatible = false).run {
        val isReadOnlyMode = editabilityState.areDnsMonitorsReadOnly()
                    ...
                    tbody {
                        monitors.forEach { monitor ->
                            tr {
                                ...
                                td {
                                    a(href = "/dns-monitors/${monitor.id}") {
                                        classes(TEXT_RESET)
                                        span {
