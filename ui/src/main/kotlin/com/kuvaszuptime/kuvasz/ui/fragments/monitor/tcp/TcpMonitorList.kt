...
fun renderTcpMonitorList(
    ...
    createHTML(prettyPrint = false, xhtmlCompatible = false).run {
        val isReadOnlyMode = editabilityState.areTcpMonitorsReadOnly()
                    ...
                    tbody {
                        monitors.forEach { monitor ->
                            tr {
                                ...
                                td {
                                    a(href = "/tcp-monitors/${monitor.id}") {
                                        classes(TEXT_RESET)
                                        span {
                                ...
                                td {
                                    classes(TEXT_NOWRAP, D_NONE, D_SM_TABLE_CELL, TEXT_CENTER)
                                    span {
