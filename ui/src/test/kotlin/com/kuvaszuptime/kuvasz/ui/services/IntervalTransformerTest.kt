...
class IntervalTransformerTest : StringSpec({
    ...
    "should limit the returned fragments at 2 elements" {
        ...
        IntervalTransformer.transform(start, end2) shouldBe "1 hour 1 minute"
    }
})
