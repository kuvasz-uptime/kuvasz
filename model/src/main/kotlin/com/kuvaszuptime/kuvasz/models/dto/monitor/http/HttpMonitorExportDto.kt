...
data class HttpMonitorExportDto(
    ...
    val crossOriginHeaderPropagation: Boolean = HttpMonitorDefaults.CROSS_ORIGIN_HEADER_PROPAGATION,
    ...
    companion object {
        fun fromMonitorRecord(record: HttpMonitorRecord): HttpMonitorExportDto {
            return HttpMonitorExportDto(
                ...
                crossOriginHeaderPropagation = record.crossOriginHeaderPropagation,
