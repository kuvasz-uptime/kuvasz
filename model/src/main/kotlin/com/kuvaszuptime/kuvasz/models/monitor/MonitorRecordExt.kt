...
import com.kuvaszuptime.kuvasz.models.monitor.docker.monitorId as dockerMonitorId
...
fun MonitorRecord.monitorId(): MonitorID = when (this) {
    ...
    is DockerMonitorRecord -> dockerMonitorId()
...
val MonitorRecord.relativeDetailsUrl: String
    get() = when (this) {
        ...
        is DockerMonitorRecord -> "/docker-monitors/${this.id}"
        else -> error("Unknown monitor type: ${this::class}")
    }
